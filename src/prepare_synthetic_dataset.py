...
def generate_data(n, batch_num, out_dir, draw_fn, background_size, image_size, blur_size, seed):
    random_state = np.random.RandomState(seed)
    
    out_dir = out_dir / str(batch_num).zfill(4)
    ...
    np.save(file.with_suffix(".npy"), points)
